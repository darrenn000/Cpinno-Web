 ...
 *   1. All embedded images → saved to ./images/<PartNo>.jpg
...
async function run() {
  ...
  // Build map: row index (0-based) → Part No.
  ...
  const products = rows.map((r, i) => {
    ...
    // Detect the image extension that was saved
    const ext =
      (mediaEntries[i] ? path.extname(mediaEntries[i].entryName) : ".jpg") ||
      ".jpg";
    ...
    return {
      ...
      image: partNo ? `images/${partNo}${ext}` : "",
    };
  });
...
`;
  ...
  console.log("  ├── index.html       (catalog page)");
  console.log("  ├── products.js      (generated)");
  console.log("  └── images/");
  console.log("      ├── 560000.jpg");
  console.log("      ├── 560001.jpg");
  console.log("      └── ...");
}
